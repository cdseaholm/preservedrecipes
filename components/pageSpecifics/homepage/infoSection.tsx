...
export default function InfoSection() {
    return (
        <div className="flex flex-row items-center justify-center w-5/6 xl:w-11/12 xl:h-2/3 h-4/5 xl:px-12 xl:py-32 xl:m-5 m-2 p-5 bg-transparent
                relative 
                overflow-hidden">
