    ...
    return (
        <section className="flex flex-row justify-between items-center h-full w-full overflow-hidden bg-mainBack min-h-[550px] p-2 rounded-md">
            <div className="flex flex-col justify-start items-center py-6 h-full w-1/4 text-center bg-mainContent pl-2 rounded-md">
                <div className="flex flex-col justify-start items-center h-1/2 bg-mainBack w-full border border-accent/50 rounded-t-md">
                    {`${userName}'s Profile`}
                    <Avatar radius={'xl'} />
                ...
                <div className="flex flex-col justify-start items-center h-1/2 bg-mainBack w-full rounded-b-md border-x border-b border-accent/50">
                    {userInfo ? (
