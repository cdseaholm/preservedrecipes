...
export default function FamilyMembers({ userInfo, type, additionString, searchString, promoString, userFamAdminPrivs, handleSettings, handleDelete, handleOptions, handleEdit, handleCheckedFam, handleCreate, handleFamilyMemberSearch, familySearch, edit, famChecked, memberNames }: { userInfo: IUser, type: string, additionString: string[], searchString: string[], promoString: string[], userFamAdminPrivs: boolean, handleSettings: () => void, handleDelete: () => void, handleOptions: () => void, handleEdit: () => void, handleCheckedFam: (index: number) => void, handleCreate: (which: string, open: boolean) => void, handleFamilyMemberSearch: (e: ChangeEvent<HTMLInputElement>) => void, familySearch: string, edit: boolean, famChecked: boolean[], memberNames: string[] }) {
