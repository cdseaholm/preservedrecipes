...
export default function FamilyMain({ userInfo, type, additionString, searchString, promoString, userFamAdminPrivs, handleSettings, handleDelete, handleOptions, handleEdit, handleCheckedRec, handleCheckedFam, handleCreate, handleFamilyMemberSearch, handleFamilyRecipeSearch, familySearch, familyRecipeSearch, edit, recChecked, famRecipeTitles, famChecked, memberNames }: { userInfo: IUser, type: string, additionString: string[], searchString: string[], promoString: string[], userFamAdminPrivs: boolean, handleSettings: () => void, handleDelete: () => void, handleOptions: () => void, handleEdit: () => void, handleCheckedRec: (index: number) => void, handleCheckedFam: (index: number) => void, handleCreate: (which: string, open: boolean) => void, handleFamilyMemberSearch: (e: ChangeEvent<HTMLInputElement>) => void, handleFamilyRecipeSearch: (e: ChangeEvent<HTMLInputElement>) => void, familySearch: string, familyRecipeSearch: string, edit: boolean, recChecked: boolean[], famRecipeTitles: string[], famChecked: boolean[], memberNames: string[] }) {
