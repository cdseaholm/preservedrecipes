                ...
                <div className="w-full scrollbar-thin scrollbar-webkit space-y-2 flex flex-col" style={{ maxHeight: '65vh', overflowY: 'auto', overflowX: 'hidden' }}>
                    <Fieldset className={`flex flex-col justify-start space-y-1 items-center h-full w-full`} key={indexToEdit}>
                        ...
                        <div className="flex flex-row w-full justify-end items-center">
                            ...
                            }} title="Delete Ingredient" className={`h-fit w-fit hover:border hover:border-accent hover:text-red-600 rounded-md border border-transparent p-1 cursor-pointer text-sm text-red-400`} aria-label="Remove ingredient">Delete</button>
                        </div>
                    </Fieldset>
                </div>
            </Fieldset>
            <section className="flex flex-row w-full justify-evenly items-center pt-5">
                <CancelButton handleCancel={() => { handleCancelChild('ingredients', indexToEdit); }} />
